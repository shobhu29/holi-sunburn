...
public class QueryActionController {
	...
	public ModelAndView registerCustomer(@Valid @ModelAttribute("customer") Query cus, BindingResult result) {
		Query customer = null;
		try {
			if (result.hasErrors())
	...
	public ModelAndView loginCustomer(@Valid @ModelAttribute("customer") Query customer, BindingResult result) {
		boolean bool;
		try {
